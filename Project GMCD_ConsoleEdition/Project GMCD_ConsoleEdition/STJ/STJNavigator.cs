...
namespace Project_GMCD_ConsoleEdition
{
    class STJNavigator
    {
        public void ConnectionPostData(string data_inicial, string data_final)
        {
            ...
            newSession.FormElements["data_inicial"] = parsedDI.ToString();
            newSession.FormElements["data_final"] = parsedDF.ToString();
            ...
            // //div[@class='linhaform']/input[@id='data_inicial']
            // //div[@class='linhaform']/input[@id='data_final']
        }
